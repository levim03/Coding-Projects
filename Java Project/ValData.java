...
public class ValData {
	...
	//private attributes/fields	
		...
		/* I was not able to implement the binary search into something that made sense.  
		 * The code works and includes recursion
		 * leaving the function here is showing I did not forget about writing a binary search, I just did not implement it
		*/
