...
public class Recommendation extends ValData { //inheritance relationship
	...
	public void calculateMap() { //will calculate the users map
		...
		if(givenMapType.equals("Close-quarter")&& givenRange.equals("Mid-range")) {
	...
	public void calculateWeapon() { //will calculate the users weapon
		...
		if(givenWeaponType.equals("Pistols")&& givenRange.equals("Mid-range")) {
		...
		if(givenWeaponType.equals("Rifles")&& givenRange.equals("Mid-range")) {
		...
		if(givenWeaponType.equals("Shotguns")&& givenRange.equals("Mid-range")) {
		...
		if(givenWeaponType.equals("LMG's")&& givenRange.equals("Mid-range")) {
		...
		if(givenWeaponType.equals("SMG's")&& givenRange.equals("Mid-range")) {
		...
		if(givenWeaponType.equals("Snipers")&& givenRange.equals("Mid-range")) {
