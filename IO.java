...
public class IO {
	...
	System.out.print("Please input the desired path to export numbers: ");
	String filePath1 = userInput.nextLine();
	
	fileStream1 = new FileOutputStream(filePath1 + "\\Numbers.txt"); //sets desired path and sends a txt file to the location
	...
	System.out.print("Please input the desired file path to be imported: ");
	
	String pathName2 = userInput.nextLine();
	
	try {
		fileStream2 = new FileInputStream(pathName2+ "\\Numbers.txt");	
		...
		fileStream2 = new FileInputStream(pathName2 + "\\Numbers.txt");  //reopen the file stream to re-read for median
		...
		System.out.println();
		System.out.print("Please type path of the file for the results: ");  //asking for result file path
		
		String pathName3 = userInput.nextLine(); 	//user input for final file output path
		FileOutputStream outputStream = new FileOutputStream(pathName3 + "\\Results.txt");  	//more file output objects
